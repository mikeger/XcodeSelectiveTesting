...
Add `.package(url: "git@github.com:mikeger/XcodeSelectiveTesting", .upToNextMajor(from: "0.9.8"))` to your `Package.swift`'s `dependencies` section.
...
`mint install mikeger/XcodeSelectiveTesting@0.9.8`
...
1. Run `mint run mikeger/XcodeSelectiveTesting@0.9.8 YourWorkspace.xcworkspace --test-plan YourTestPlan.xctestplan`
...
1. Add code to install the tool
2. Add a CI step before you execute your tests: `mint run mikeger/XcodeSelectiveTesting@0.9.8 YourWorkspace.xcworkspace --test-plan YourTestPlan.xctestplan --base-branch $PR_BASE_BRANCH`
